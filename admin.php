...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !$isVercel) {
    ...
    $textFields = [
        'phone_no', 'ov_title', 'ov_desc', 'p_2bhk_area', 'p_2bhk_price', 'p_3bhk_area', 'p_3bhk_price', 'p_4bhk_area',
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="section-box">
            ...
            <div class="grid">
                ...
                <div><label>1 BHK Area:</label><input type="text" name="p_2bhk_area" value="<?= htmlspecialchars($data['p_2bhk_area'] ?? '') ?>"></div>
                <div><label>1 BHK Price:</label><input type="text" name="p_2bhk_price" value="<?= htmlspecialchars($data['p_2bhk_price'] ?? '') ?>"></div>
                <div><label>2 BHK Area:</label><input type="text" name="p_3bhk_area" value="<?= htmlspecialchars($data['p_3bhk_area'] ?? '') ?>"></div>
                <div><label>2 BHK Price:</label><input type="text" name="p_3bhk_price" value="<?= htmlspecialchars($data['p_3bhk_price'] ?? '') ?>"></div>
                <div class="full"><label>1+1 Jodi (3 BHK) Area:</label><input type="text" name="p_4bhk_area" value="<?= htmlspecialchars($data['p_4bhk_area'] ?? '') ?>"></div>
            </div>
        </div>

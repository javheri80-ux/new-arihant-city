...
function doGet(e) {
  try {
    ...
    // Send email notification to javheri80@gmail.com
    try {
      MailApp.sendEmail({
        to: "javheri80@gmail.com",
        subject: "New Lead: " + (data.project_name || "Arihant City Kalyan"),
        body: "A new lead has been submitted on the website:\n\n" +
              "Project Name: " + (data.project_name || "Arihant City Kalyan") + "\n" +
              "Name: " + (data.name || "N/A") + "\n" +
      ...
      console.error("Failed to send email notification: " + mailErr.toString());
    }

...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Mobile Fixed Contact Bar styling */
        .mobile-contact-bar {
            display: none;
            position: fixed;
            bottom: 0;
        ...
        .mobile-contact-bar .contact-item:not(:last-child) {
        ...
        @media (max-width: 768px) {
            ...
            /* Avoid bottom layout content overlap */
            body {
                padding-bottom: 60px;
            }
        }
    ...
    <!-- Sitelinks Searchbox & WebSite Schema for GEO/AEO -->
    <script type="application/ld+json" id="sitelinks-searchbox">
    {
      "@context": "https://schema.org",
      "@type": "WebSite",
...
<body>
    ...
    <header>
        <div class="nav-container container">
            <a href="index.php" aria-label="Arihant City Home"><img id="logo"
                    ...
                    alt="Arihant City Kalyan Bhiwandi logo - premium real estate township project in Thane district" class="logo-img"></a>
            <nav aria-label="Main Navigation">
                ...
                <ul class="nav-links" id="nav-list">
                    ...
                    <li><a href="https://www.arihant.city/blog">Blog</a></li>
    ...
    <main>
        ...
        <img src="<?= get_val('hero_banner', 'images/hero_banner_1776905712.webp') ?>"
            alt="Arihant City township aerial view - premium residential flats for sale in Thane Kalyan Bhiwandi Bypass" class="hero" width="1200"
            height="600">
            ...
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>1 BHK Luxury</td>
                            <td><?= get_val('p_2bhk_area', '543 Sq.Ft. Carpet') ?></td>
                            <td><button class="btn price-btn" style="margin-top:0; padding: 5px 15px;">Price on Request</button></td>
                            <td>Available</td>
                        </tr>
                        <tr>
                            <td>2 BHK Elite</td>
                            <td><?= get_val('p_3bhk_area', '793 Sq.Ft. Carpet') ?></td>
                            <td><button class="btn price-btn" style="margin-top:0; padding: 5px 15px;">Price on Request</button></td>
                            <td>Available</td>
                        </tr>
                        <tr>
                            <td>1+1 jodi( 3bhk )</td>
                            <td><?= get_val('p_4bhk_area', '1080 Sq.Ft. Carpet') ?></td>
                            <td><button class="btn price-btn" style="margin-top:0; padding: 5px 15px;">Price on Request</button></td>
                            <td>Limited</td>
                        </tr>
                    </tbody>
        ...
        <section class="section-padding" style="background-color: var(--light-green);">
            <div class="container text-center">
                ...
                <img src="<?= get_val('story_img', 'images/story_img_1776905960.webp') ?>"
                    alt="Arihant City Kalyan Bhiwandi developer story - legacy of premium real estate projects in Thane district"
        ...
        <section id="connectivity" class="section-padding" style="background-color: var(--light-maroon);">
            <div class="container text-center">
                ...
                <p class="section-subtitle">Schools, hospitals, shopping malls, and highways—everything you need is situated close to your new home.</p>
                <div class="conn-grid">
                    <div class="conn-col">
                        <h4>Transport</h4>
                        <ul>
        ...
        <section id="plans" class="section-padding container text-center">
            ...
            <div class="grid-2x2">
                <img src="<?= get_val('fp1_img', 'images/fp1_img_1776490386.webp') ?>"
                    alt="Arihant City Kalyan Bhiwandi 1 BHK and 2 BHK flats floor plan layout diagram" style="border: 1px solid #ddd;"
                    loading="lazy">
                <img src="<?= get_val('fp2_img', 'images/fp2_img_1776490386.webp') ?>"
                    alt="Arihant City Kalyan Bhiwandi 3 BHK jodi and 4 BHK premium flats floor plan layout diagram" style="border: 1px solid #ddd;"
                    loading="lazy">
            </div>
        </section>
        ...
        <section id="gallery" class="section-padding container text-center">
            ...
            <div class="grid-2x2">
                <img src="<?= get_val('gal1_img', 'images/gal1_img_1777043382.webp') ?>"
                    alt="Arihant City Kalyan Bhiwandi actual project site building construction status view"
                    style="border: 1px solid #ddd; border-radius: 8px;" loading="lazy">
                <img src="<?= get_val('gal2_img', 'images/gal2_img_1777043382.webp') ?>"
                    alt="Arihant City Kalyan Bhiwandi sample flat interior model showroom design"
                    style="border: 1px solid #ddd; border-radius: 8px;" loading="lazy">
            </div>
        </section>
        ...
        <section id="blogs" class="section-padding container">
            ...
            <div class="grid-2x2">
                <div class="card" style="text-align: left; padding: 20px;">
                    ...
                    <p style="font-size: 0.9rem; color: #555;">Discover why Arihant City is the ideal choice for first-time homebuyers and young professionals seeking premium residences...</p>
                ...
                <div class="card" style="text-align: left; padding: 20px;">
                    <h3 style="color: var(--primary-green); margin-bottom: 10px;">Kalyan-Bhiwandi Bypass Development
                    </h3>
                    <p style="font-size: 0.9rem; color: #555;">Learn how the rapid development of the Kalyan-Bhiwandi Bypass corridor is turning Arihant City into a prime residential hub...</p>
                    <a href="blog/residential-projects-in-thane.html"
                        style="color: var(--primary-green); font-weight: bold; text-decoration: none; display: block; margin-top: 10px;">Read
                        More &rarr;</a>
                </div>
                <div class="card" style="text-align: left; padding: 20px;">
                    <h3 style="color: var(--primary-green); margin-bottom: 10px;">Affordable Premium Flats in Thane District</h3>
                    <p style="font-size: 0.9rem; color: #555;">Get access to world-class luxury amenities and features without exceeding your home-buying budget at Arihant City...</p>
                ...
                <div class="card" style="text-align: left; padding: 20px;">
                    ...
                    <p style="font-size: 0.9rem; color: #555;">Find out why real estate industry experts consider investing in Arihant City a smart decision to secure your future...</p>
            ...
            <div class="text-center" style="margin-top: 30px;">
                <a href="blog.html" class="btn">View All Articles</a>
            </div>
        </section>
        ...
        <section class="section-padding container text-center" style="background-color: #fcfbf7;">
            ...
            <div class="grid-2x2">
                <div class="testimonial-card" itemscope itemtype="https://schema.org/Review">
                    ...
                    <p itemprop="reviewBody">"Arihant City fulfilled our dream home aspirations. The environment, active clubhouse, and outstanding connectivity to Kalyan station are highly appreciated by our family. It is truly a premium township!"</p>
                ...
                <div class="testimonial-card" itemscope itemtype="https://schema.org/Review">
                    ...
                    <p itemprop="reviewBody">"I purchased a 2 BHK flat here and I am highly satisfied with the structural construction quality. Getting such premium amenities at this price point is remarkable. Highly recommended."</p>
                    <h4 itemprop="author" itemscope itemtype="https://schema.org/Person"
                ...
                <div class="testimonial-card" itemscope itemtype="https://schema.org/Review">
                    ...
                    <p itemprop="reviewBody">"We surveyed multiple projects in Bhiwandi, but being a fully MahaRERA registered development gave us absolute peace of mind. The sales desk was helpful and the booking flow was seamless."</p>
                    <h4 itemprop="author" itemscope itemtype="https://schema.org/Person"
        ...
        <section class="section-padding container text-center">
            <h2 class="section-title">Frequently Asked Questions – Arihant City</h2>
            <div class="faq-accordion">
                <div class="faq-item">
                    <div class="faq-q"
                        onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'block' ? 'none' : 'block'">
                        <span>What is the exact location of Arihant City?</span>
                        <span>▼</span>
                    </div>
                    <div class="faq-a">Arihant City is located at the prime Kalyan Bypass, Bhiwandi, offering excellent connectivity to highways and public transport.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-q"
                        onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'block' ? 'none' : 'block'">
                        <span>What is the starting price of flats in Arihant City?</span>
                        <span>▼</span>
                    </div>
                    <div class="faq-a">The starting price for 1 BHK flats starts at ₹35 Lakhs. Pricing varies depending on configuration, layout, and current construction phase.</div>
                </div>
                <div class="faq-item">
                    <div class="faq-q"
                        onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'block' ? 'none' : 'block'">
    ...
    <!-- Related Search Links for SEO Mesh Internal Linking -->
    <section class="related-links" style="background-color: #faf8f5; padding: 40px 0; border-top: 1px solid #eee;">
        <div class="container">
            <h3 style="color: var(--primary-maroon); margin-bottom: 20px; font-size: 1.4rem; font-family: 'Outfit', sans-serif;">Trending Property Searches in Bhiwandi</h3>
            <div style="display: flex; flex-wrap: wrap; gap: 10px 15px; font-size: 0.9rem; line-height: 1.6;">
                <a href="https://www.arihant.city/2-bhk-flat-in-bhiwandi" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">2 BHK Flat in Bhiwandi</a> |
                <a href="https://www.arihant.city/2-bhk-flat-in-bhiwandi-price" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">2 BHK Flat in Bhiwandi Price</a> |
                <a href="https://www.arihant.city/2-bhk-flat-in-bhiwandi-for-sale" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">2 BHK Flat in Bhiwandi for Sale</a> |
                <a href="https://www.arihant.city/2-bhk-flat-in-anjur-phata-bhiwandi" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">2 BHK Flat in Anjur Phata Bhiwandi</a> |
                <a href="https://www.arihant.city/ready-to-move-flats-in-bhiwandi" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Ready to Move Flats in Bhiwandi</a> |
                <a href="https://www.arihant.city/bhiwandi-1-bhk-flat" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Bhiwandi 1 BHK Flat</a> |
                <a href="https://www.arihant.city/1-bhk-flat-in-bhiwandi-for-sale" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">1 BHK Flat in Bhiwandi for Sale</a> |
                <a href="https://www.arihant.city/bhiwandi-1-bhk-flat-price" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Bhiwandi 1 BHK Flat Price</a> |
                <a href="https://www.arihant.city/flats-in-bhiwandi" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Flats in Bhiwandi</a> |
                <a href="https://www.arihant.city/flats-for-sale-in-bhiwandi-millat-nagar" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Flats for Sale in Bhiwandi Millat Nagar</a> |
                <a href="https://www.arihant.city/bhiwandi-flat-rate" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Bhiwandi Flat Rate</a> |
                <a href="https://www.arihant.city/commercial-property-in-bhiwandi" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Commercial Property in Bhiwandi</a> |
                <a href="https://www.arihant.city/bhiwandi-property-rates-per-square-feet" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Bhiwandi Property Rates Per Square Feet</a> |
                <a href="https://www.arihant.city/property-in-bhiwandi-millat-nagar" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Property in Bhiwandi Millat Nagar</a> |
                <a href="https://www.arihant.city/olx-bhiwandi-property" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">OLX Bhiwandi Property</a> |
                <a href="https://www.arihant.city/bhiwandi-property-tax" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Bhiwandi Property Tax</a> |
                <a href="https://www.arihant.city/property-in-bhiwandi" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Property in Bhiwandi</a> |
                <a href="https://www.arihant.city/property-in-bhiwandi-for-sale" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Property in Bhiwandi for Sale</a> |
                <a href="https://www.arihant.city/luxury-property-in-bhiwandi" style="color: var(--primary-maroon); text-decoration: none; font-weight: 500;">Luxury Property in Bhiwandi</a>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="container" style="text-align: center; color: #fff; line-height: 1.6;">
            <div style="margin-bottom: 20px;">
                ...
                <a href="blog.html" style="color: #fff; text-decoration: none; margin: 0 10px;">Blogs</a> |
    ...
    <div class="modal-overlay" id="loadPopup" style="display:none;">
        <div class="modal-content" style="animation: popupBounce 0.5s ease-out;">
            <div class="modal-header" style="background: linear-gradient(135deg, #1a0a2e, var(--primary-maroon), #7a0220);">
                <span class="modal-close" id="closeLoadPopup">&times;</span>
                <h2 style="font-size:1.3rem;">🏠 Schedule a Free Site Visit</h2>
                <p style="font-size:0.9rem; margin-top:8px;">Register now to book a guided site visit & get detailed project pricing</p>
            </div>
            <div class="modal-body">
                <form action="https://formsubmit.co/javheri80@gmail.com" method="POST" aria-label="Arihant City Page Load Enquiry Form">
                    ...
                    <button type="submit" class="modal-submit-btn" aria-label="Book Free Site Visit">🎯 Book Free Site Visit</button>
                </form>
                <p style="text-align:center; font-size:0.7rem; color:#999; margin-top:12px;">*Complimentary pick-up & drop-off service is available from key points in Thane, Kalyan, and neighboring stations for scheduled site visits.</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        closeLoadPopup.addEventListener('click', () => {
            loadPopup.style.display = 'none';
        });

        window.addEventListener('click', (e) => {
            if (e.target === loadPopup) {
                loadPopup.style.display = 'none';
            }
        });

        // Mobile contact bar enquiry action
        document.querySelectorAll('.price-btn-mobile').forEach(btn => {
            btn.addEventListener('click', (e) => {
